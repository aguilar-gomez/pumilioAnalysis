...
png(filename="trace.png")
#We format the plots
par(mfrow=c(3,3))

#We assume that the output of the 3 independently run chains are
#chain1.txt, chain2.txt, and chain3.txt
Chain1 = read.csv("Frog1/output1.csv")
Chain2 = read.csv("Frog2/output1.csv")
Chain3 = read.csv("Frog3/output1.csv")
...
dev.off()
png(filename="Autocorrelation.png")
